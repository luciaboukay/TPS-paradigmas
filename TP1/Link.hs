...
newL city1 city2 qualityL | nameC city1 == nameC city2 = error "Error de definicion del enlace: No es posible crear enlaces dentro de una misma ciudad."
                          | distanceC city1 city2 == 0 = error "Error de definicion del enlace: No es posible crear enlaces en un mismo punto."
                          | otherwise = Lin city1 city2 qualityL
...
delayL (Lin city1L city2L quality) = distanceC city1L city2L / delayQ quality